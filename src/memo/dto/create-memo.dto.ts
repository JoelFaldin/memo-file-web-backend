import { IsEnum, IsInt, IsNotEmpty, IsNumber, IsOptional, IsString, Matches, Max, Min } from "class-validator";
...
export class CreateMemoDto {
    ...
    @IsEnum(["COMER", "PROFE", "INDUS", "ALCOH", "MEF"], {
        message: 'Tipo de patente no válido. Debe ser COMER, PROFE, INDUS, ALCOH o MEF'
    })
    tipo: string;
